...
define('kodr-mock/routes/user-arenas', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "current_user.username", ["loc", [null, [22, 54], [22, 79]]]]],
        locals: [],
        templates: []
      };
    })();
    ...
    var child2 = (function () {
      return {
        ...
        statements: [["inline", "arena-item", [], ["arena", ["subexpr", "@mut", [["get", "arena", ["loc", [null, [50, 24], [50, 29]]]]], [], []]], ["loc", [null, [50, 5], [50, 31]]]]],
        locals: ["arena"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "if", [["get", "current_user.email", ["loc", [null, [20, 12], [20, 30]]]]], [], 0, 1, ["loc", [null, [20, 6], [34, 13]]]], ["content", "outlet", ["loc", [null, [41, 3], [41, 13]]]], ["inline", "login-page", [], ["store", ["subexpr", "@mut", [["get", "store", ["loc", [null, [42, 23], [42, 28]]]]], [], []]], ["loc", [null, [42, 4], [42, 30]]]], ["block", "each", [["get", "model", ["loc", [null, [49, 12], [49, 17]]]]], [], 2, null, ["loc", [null, [49, 4], [51, 13]]]]],
      locals: [],
...
define("kodr-mock/templates/components/arena-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["content", "arena.name", ["loc", [null, [21, 7], [21, 21]]]], ["content", "arena.description", ["loc", [null, [23, 33], [23, 54]]]], ["content", "yield", ["loc", [null, [33, 0], [33, 9]]]]],
      locals: [],
      templates: []
    };
  })());
...
define("kodr-mock/templates/user-arenas", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "fragmentReason": {
        ...
        "moduleName": "kodr-mock/templates/user-arenas.hbs"
      },
      isEmpty: false,
      arity: 0,
      cachedFragment: null,
...
if (!runningTests) {
  require("kodr-mock/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"name":"kodr-mock","version":"0.0.0+fb048379"});
}
